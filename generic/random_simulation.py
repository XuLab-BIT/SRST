...
import decode.utils
import generic.emitter_generator
...
def setup_random_simulation(param):
    ...
    prior_train =generic.emitter_generator.EmitterSamplerBlinking.parse(
    ...
    prior_test = generic.emitter_generator.EmitterSamplerBlinking.parse(
