...
class Simulation:
    ...
    def sample(self):
        ...
        frames, bg, nobg = self.forward(emitter)
        return emitter, frames, bg, nobg
    ...
    def forward(self, em: EmitterSet, ix_low: Union[None, int] = None, ix_high: Union[None, int] = None) -> Tuple[
        ...
        nobg_frames = self.psf.forward(em.xyz_px, em.phot, em.frame_ix,
        ...
        if self.background is not None:
            frames, bg_frames = self.background.forward(nobg_frames)
        else:
            bg_frames = None
            frames = nobg_frames
        ...
        return frames, bg_frames, nobg_frames
